        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackupType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BackupMetadata_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataSharingNotifications = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileChangeHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProfileChangeHistory_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceFingerprint = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PrivacyLevel = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    ...
                    DisplayPreferences = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShareAccessLogs_ShareTokens_ShareTokenId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileChangeHistory_ChangedAt",
                table: "ProfileChangeHistory",
                column: "ChangedAt");

            migrationBuilder.CreateIndex(
                name: "IX_ProfileChangeHistory_UserId",
                table: "ProfileChangeHistory",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShareAccessLogs_ShareTokenId",
